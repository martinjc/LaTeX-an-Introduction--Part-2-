...
\vfill
If our tables and images are `floating' around the document, they may end up being in a different location to the text describing them. \LaTeX\ provides methods for cross-referencing within documents.
\vfill
